# reader-auth Specification

## Purpose

Allow visitors to register, log in, and log out as readers on dedicated public routes, with sessions that never grant dashboard access.
