...
Authenticate and authorize editorial/admin users through a dashboard login that is independent from reader authentication, with role-based access control and dashboard route protection.
